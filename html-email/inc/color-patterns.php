 ...
 */
function htmlemail_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter HTML Email default saturation level.
	 *
	 * @since HTML Email 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'htmlemail_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.htmlemail-front-page) .entry-title,
...
.colors-custom .htmlemail-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.htmlemail-front-page .panel-content .recent-posts article,
...
.colors-custom.htmlemail-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters HTML Email custom colors CSS.
	 *
	 * @since HTML Email 1.0
	 *
	 ...
	 */
	return apply_filters( 'htmlemail_custom_colors_css', $css, $hue, $saturation );
}
